...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/13 14:30:13 by aileong           #+#    #+#             */
/*   Updated: 2024/01/14 16:37:11 by aileong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * to fulfil a specified shape using characters 'o', '-', and '|'.
 *
 * @param	int width
 * @param	int height
 */
